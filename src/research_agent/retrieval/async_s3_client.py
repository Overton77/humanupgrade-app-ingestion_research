...
# Optional: quick manual test runner
# if __name__ == "__main__":
#     async def _test():
#         test_url = (
#             "https://biohack-agent-transcripts-us-east-2.s3.amazonaws.com/"
#             "transcripts-text/aa4b0d2449c576a8.txt"
#         )
#         text = await get_transcript_text_from_s3_url(test_url)
