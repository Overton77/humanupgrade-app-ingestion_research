...
PRIMARY BUSINESS, products, platforms, and related compounds.
...
- Prioritize the GUEST’S primary company, products, platforms, and services.
...
- If exact names (guest, business, product, platform) are unclear or truncated, you may:
...
B) Identify candidate entities in these buckets:
   ...
   - platform_candidates (PLATFORM): named technologies, platforms, or processes developed or used by the guest’s business
...
C) For each CandidateEntity:
   ...
   - typeHint: PERSON | ORGANIZATION | PRODUCT | PLATFORM | COMPOUND | OTHER
