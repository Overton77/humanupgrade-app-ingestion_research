...
def merge_dict_of_latest(prev: Optional[Dict[str, Any]], nxt: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    """
    Overwrite per-key, but keep the dict. Useful for:
      substage_outputs[substage_id] = <something>
    """
